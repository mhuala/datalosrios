...
import hublogo from "../Images/hub-logo.svg";
        ...
        >
          <defs>
            <linearGradient id="sw-gradient-0" x1={0} x2={0} y1={1} y2={0}>
              <stop stopColor="rgba(67, 56, 202, 1)" offset="0%" />
              <stop stopColor="rgba(13, 13, 43, 1)" offset="100%" />
            </linearGradient>
          </defs>
          <path
            ...
            <div className="px-5 py-16 grid grid-cols-1 md:grid-cols-5 mx-auto">
              ...
              <div className="col-span-1">
                <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                  <img src={hublogo} className="h-32 mb-10 pr-10" />
                </a>
                  ...
                  <div className="gmap_canvas ">
                    ...
                    <style
                      dangerouslySetInnerHTML={{
                        __html:
                          ".mapouter{position:relative;text-align:right;height:142px;width:417px;}",
                      }}
                    />
                    ...
                    <style
                      dangerouslySetInnerHTML={{
                        __html:
                          ".gmap_canvas {overflow:hidden;background:none!important;height:142px;width:417px;}",
                      }}
                    />
                  </div>
                </div>
