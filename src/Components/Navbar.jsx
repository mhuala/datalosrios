    ...
    <div className="container mx-auto px-2">
        ...
        <div className=" hidden md:flex flex-row justify-center items-center space-x-8">
          ...
          <div className="flex flex-row items-center space-x-8">
            <a href="/" className="clickeable">
              <span className="text-white font-bold font-rale">Inicio</span>
            </a>
            <a href="/region" className="clickeable">
              <span className="text-white font-bold font-rale">Región</span>
            </a>
            <a href="/cities" className="clickeable">
              <span className="text-white font-bold font-rale">Ciudades</span>
            </a>
      ...
      >
        ...
        <a
          ...
          className="clickeable text-center  block mx-auto w-11/12"
        >
          <span className="text-center font-semibold">Exportaciones</span>
        </a>
        <a
          href="/simulation"
          className="clickeable text-center  block mx-auto w-11/12 "
        >
          <span className="text-center font-semibold py-1">Simulación</span>
        </a>
      </div>
    </div>
  );
