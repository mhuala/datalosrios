    ...
    <div className="flex flex-col bg-brand py-20">
      <div className="flex flex-col mx-auto items-center justify-center ">
        <div className="flex flex-row ">
          <img src="https://es.datachile.io/images/icons/icon-search.svg" alt="" className="h-10 pr-3 rotate-45" />
          <h2 className="pl-3 text-white font-rale text-2xl">BUSCA TU COMUNA DE INTERÉS</h2>
        </div>
      </div>
